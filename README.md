...
- `.nopal/bundle.jsonc` pins Pi resources, including the enforcement adapter.
...
| `.nopal/` | Checked-in project and distribution contract |
...
Start with [ADR 0012](docs/adr/0012-reset-nopal-to-an-enforced-pi-distribution.md) for the v0.3 product boundary.
