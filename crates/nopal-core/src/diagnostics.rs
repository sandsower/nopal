...
impl Code {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Code::ProductSurfaceRemoved => "product_surface_removed",
            ...
            Code::LedgerTransitionInvalid => "ledger_transition_invalid",
            Code::LedgerLimitExceeded => "ledger_limit_exceeded",
