...
impl VerifiedSessionEvent {
    ...
    pub(crate) fn previous_cursor(&self) -> Option<&str> {
        match self {
    ...
    pub(crate) fn user_message_command_id(&self) -> Option<&str> {
        match self {
    ...
    pub(crate) fn semantic_session_event(&self) -> Option<SessionEvent> {
        match self {
