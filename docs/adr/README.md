...
These records describe durable Nopal architecture decisions.

- [ADR 0010: Nopal identity clean break](0010-nopal-identity-clean-break.md)
- [ADR 0011: Pi authoritative session and model control](0011-pi-authoritative-session-model-control.md)
