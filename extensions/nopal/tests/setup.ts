 ...
 * internal relative imports (e.g. `nopal-cli.ts`) don't need this and can
 * be imported statically as usual.
 *
...
export async function loadNopalModule<T>(relativePath: string): Promise<T> {
